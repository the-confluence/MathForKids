...
:: Android packaging
set AND_CERT_NAME="MathForKids"
set AND_CERT_PASS=test
set AND_CERT_FILE=cert\MathForKids.p12
...
set IOS_PROVISION=cert\MathForKids.mobileprovision
...
set APP_ID=air.com.bewitchedgames.mathforkids

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MathForKids
